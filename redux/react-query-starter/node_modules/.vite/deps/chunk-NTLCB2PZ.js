...
var Overlay = React.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react7.useState)(!props.show);
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react8.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React3.forwardRef(({
  ...
  const popperRef = (0, import_react9.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react9.useState)(null);
  ...
  return (0, import_jsx_runtime3.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react10.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react10.useRef)("");
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React4.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  const handleHide = (0, import_react10.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react10.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react10.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react10.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react10.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react10.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime6.jsxs)(import_jsx_runtime5.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react10.cloneElement)(children, triggerProps), (0, import_jsx_runtime4.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
//# sourceMappingURL=chunk-NTLCB2PZ.js.map
