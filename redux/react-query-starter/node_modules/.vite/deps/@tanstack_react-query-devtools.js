...
import {
  ...
  mergeProps,
  render
} from "./chunk-GB2Y2NT3.js";
import {
  onlineManager,
  useQueryClient
} from "./chunk-P7P57PHN.js";
import {
  require_react
...
var _client, _onlineManager, _queryFlavor, _version, _isMounted, _buttonPosition, _position, _initialIsOpen, _errorTypes, _Component, _dispose, _a;
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet(this, _Component)) {
        ...
        Devtools = lazy(() => import("./MVUALMJ4-3U7JECVS.js"));
...
}, _client = new WeakMap(), _onlineManager = new WeakMap(), _queryFlavor = new WeakMap(), _version = new WeakMap(), _isMounted = new WeakMap(), _buttonPosition = new WeakMap(), _position = new WeakMap(), _initialIsOpen = new WeakMap(), _errorTypes = new WeakMap(), _Component = new WeakMap(), _dispose = new WeakMap(), _a);
